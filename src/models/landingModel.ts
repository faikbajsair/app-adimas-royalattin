...
export async function seedDefaultLandingData(): Promise<void> {
  ...
  const defaultItems = [
    ...
    // about unit cards
    { id: 'about-1', section_id: 'about', title: 'KB-TK Taman Main', description: 'Mengembangkan motorik kasar-halus, kemandirian sosial-emosional, serta pengenalan dasar Al-Qur\'an dalam lingkungan bermain yang ceria dan merangsang kreativitas anak.', image_url: '/images/jenjang_kbtk.jpg', badge: '🎨', link_url: '', order_index: '1', extra_data: '' },
    { id: 'about-2', section_id: 'about', title: 'SD Royal At-Tin', description: 'Mengintegrasikan kurikulum nasional K-Merdeka dengan penguatan adab Islam harian, pembiasaan ibadah sunnah, serta target penguasaan hafalan Al-Qur\'an secara terstruktur.', image_url: '/images/jenjang_sd.jpg', badge: '📚', link_url: '', order_index: '2', extra_data: '' },
    { id: 'about-3', section_id: 'about', title: 'NURA Tahfidz Center', description: 'Program intensif khusus tahfidz Quran dengan pengajar berpengalaman, melatih pelafalan makhroj huruf yang fasih, tajwid dasar, serta murojaah yang konsisten.', image_url: '/images/jenjang_nura.jpg', badge: '✨', link_url: '', order_index: '3', extra_data: '' },
    // tech cards
